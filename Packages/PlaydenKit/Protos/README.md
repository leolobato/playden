...
```sh
protoc --swift_out=Packages/PlaydenKit/Sources/SteamCloudProto \
  --swift_opt=Visibility=Public --proto_path=Packages/PlaydenKit/Protos \
  Packages/PlaydenKit/Protos/cloud_read.proto Packages/PlaydenKit/Protos/cloud_write.proto
```
